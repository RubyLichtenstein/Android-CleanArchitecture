...
public class StreamReaderTest {
  ...
  private final String STREAM_DATA_3 =
      "Ah1UMvJrhEl44PZpuWiDvrL3DU9ZN8iaP80VZ35moKN6qoF9bM54ssWmVKkZTCKc56eBuExnxN43pS68zjphwN9jH0fVW8AMOrWS06LWVuqBbYRPnlLOBt132sXSZwVvIUVhmc8BYrYMVCD"
  ...
  private void assertReadInputStream(String in) throws IOException {
    InputStream inputStream = createInputStream(in);
    String out = streamReader.read(inputStream);
